...
def run_all_methods(feed1, feed2, n_of_splits, two_dimensions, jk):
    ...
    rms_mean, rms_sig = my_xs.run_noise_sims_2d(5)                  # CHANGE TO 50 WHEN DONE DEVELOPING
...
def all_feed_combo_xs(p):
    ...
    spectra = run_all_methods(i, j, n_of_splits, two_dimensions, jk)
    return spectra
