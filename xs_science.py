...
def plot_nulltest(cesc):
   ...
   plt.figlegend((l1,l2,l3,l4, l5, l6), ('Winter/Summer split', 'Half-mission split', 'Odd/Even split', 'Day/Night split', 'Ambient temperature', 'Wind speed'),loc='upper center',bbox_to_anchor=(0.52,1.), ncol=6, fontsize=16)
   plt.tight_layout()
   if cesc == '0':
